...
class itkCenteredAffineTransformD2(itkAffineTransformPython.itkAffineTransformD2):
    ...
    def __New_orig__() -> "itkCenteredAffineTransformD2_Pointer":
    ...
    def Clone(self) -> "itkCenteredAffineTransformD2_Pointer":
    ...
    def GetInverse(self, inverse: 'itkCenteredAffineTransformD2') -> "bool":
    ...
    def cast(obj: 'itkLightObject') -> "itkCenteredAffineTransformD2 *":
...
def itkCenteredAffineTransformD2___New_orig__() -> "itkCenteredAffineTransformD2_Pointer":
    """itkCenteredAffineTransformD2___New_orig__() -> itkCenteredAffineTransformD2_Pointer"""
    return _itkCenteredAffineTransformPython.itkCenteredAffineTransformD2___New_orig__()

def itkCenteredAffineTransformD2_cast(obj: 'itkLightObject') -> "itkCenteredAffineTransformD2 *":
...
class itkCenteredAffineTransformD3(itkAffineTransformPython.itkAffineTransformD3):
    ...
    def __New_orig__() -> "itkCenteredAffineTransformD3_Pointer":
    ...
    def Clone(self) -> "itkCenteredAffineTransformD3_Pointer":
    ...
    def GetInverse(self, inverse: 'itkCenteredAffineTransformD3') -> "bool":
    ...
    def cast(obj: 'itkLightObject') -> "itkCenteredAffineTransformD3 *":
...
def itkCenteredAffineTransformD3___New_orig__() -> "itkCenteredAffineTransformD3_Pointer":
    """itkCenteredAffineTransformD3___New_orig__() -> itkCenteredAffineTransformD3_Pointer"""
    return _itkCenteredAffineTransformPython.itkCenteredAffineTransformD3___New_orig__()

def itkCenteredAffineTransformD3_cast(obj: 'itkLightObject') -> "itkCenteredAffineTransformD3 *":
