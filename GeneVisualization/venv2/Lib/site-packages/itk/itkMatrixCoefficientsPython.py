...
class itkMatrixCoefficientsQEMD2(object):
    ...
    def __call__(self, iMesh: 'itkQuadEdgeMeshD2', iEdge: 'itkGeometricalQuadEdgeULLULLBBF') -> "float":
        """__call__(itkMatrixCoefficientsQEMD2 self, itkQuadEdgeMeshD2 iMesh, itkGeometricalQuadEdgeULLULLBBF iEdge) -> float"""
...
class itkMatrixCoefficientsQEMD3(object):
    ...
    def __call__(self, iMesh: 'itkQuadEdgeMeshD3', iEdge: 'itkGeometricalQuadEdgeULLULLBBF') -> "float":
        """__call__(itkMatrixCoefficientsQEMD3 self, itkQuadEdgeMeshD3 iMesh, itkGeometricalQuadEdgeULLULLBBF iEdge) -> float"""
