...
def anisotropic_fourth_order_level_set_image_filter_init_docstring():
    ...
    if isinstance(itk.AnisotropicFourthOrderLevelSetImageFilter, itkTemplate.itkTemplate):
        anisotropic_fourth_order_level_set_image_filter.__doc__ = itk.AnisotropicFourthOrderLevelSetImageFilter.values()[0].__doc__
    else:
        anisotropic_fourth_order_level_set_image_filter.__doc__ = itk.AnisotropicFourthOrderLevelSetImageFilter.__doc__
