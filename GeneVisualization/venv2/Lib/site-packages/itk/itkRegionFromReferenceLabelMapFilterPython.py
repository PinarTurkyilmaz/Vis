...
def region_from_reference_label_map_filter_init_docstring():
    ...
    if isinstance(itk.RegionFromReferenceLabelMapFilter, itkTemplate.itkTemplate):
        region_from_reference_label_map_filter.__doc__ = itk.RegionFromReferenceLabelMapFilter.values()[0].__doc__
    else:
        region_from_reference_label_map_filter.__doc__ = itk.RegionFromReferenceLabelMapFilter.__doc__
