...
class itkDiffusionTensor3DD(itkSymmetricSecondRankTensorPython.itkSymmetricSecondRankTensorD3):
    ...
    def GetTrace(self) -> "double":
        """GetTrace(itkDiffusionTensor3DD self) -> double"""
        return _itkDiffusionTensor3DPython.itkDiffusionTensor3DD_GetTrace(self)


    def GetFractionalAnisotropy(self) -> "double":
        """GetFractionalAnisotropy(itkDiffusionTensor3DD self) -> double"""
        return _itkDiffusionTensor3DPython.itkDiffusionTensor3DD_GetFractionalAnisotropy(self)


    def GetRelativeAnisotropy(self) -> "double":
        """GetRelativeAnisotropy(itkDiffusionTensor3DD self) -> double"""
        return _itkDiffusionTensor3DPython.itkDiffusionTensor3DD_GetRelativeAnisotropy(self)


    def GetInnerScalarProduct(self) -> "double":
        """GetInnerScalarProduct(itkDiffusionTensor3DD self) -> double"""
