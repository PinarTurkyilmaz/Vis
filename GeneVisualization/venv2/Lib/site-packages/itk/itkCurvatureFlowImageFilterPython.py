...
def curvature_flow_image_filter_init_docstring():
    ...
    if isinstance(itk.CurvatureFlowImageFilter, itkTemplate.itkTemplate):
        curvature_flow_image_filter.__doc__ = itk.CurvatureFlowImageFilter.values()[0].__doc__
    else:
        curvature_flow_image_filter.__doc__ = itk.CurvatureFlowImageFilter.__doc__
