...
def shift_scale_label_map_filter_init_docstring():
    ...
    if isinstance(itk.ShiftScaleLabelMapFilter, itkTemplate.itkTemplate):
        shift_scale_label_map_filter.__doc__ = itk.ShiftScaleLabelMapFilter.values()[0].__doc__
    else:
        shift_scale_label_map_filter.__doc__ = itk.ShiftScaleLabelMapFilter.__doc__
