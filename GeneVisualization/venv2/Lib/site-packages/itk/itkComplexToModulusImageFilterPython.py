...
def complex_to_modulus_image_filter_init_docstring():
    ...
    if isinstance(itk.ComplexToModulusImageFilter, itkTemplate.itkTemplate):
        complex_to_modulus_image_filter.__doc__ = itk.ComplexToModulusImageFilter.values()[0].__doc__
    else:
        complex_to_modulus_image_filter.__doc__ = itk.ComplexToModulusImageFilter.__doc__
