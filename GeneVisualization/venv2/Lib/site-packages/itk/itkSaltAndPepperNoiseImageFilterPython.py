...
class itkSaltAndPepperNoiseImageFilterIF2IF2(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterIF2IF2):
    ...
    def SetSaltValue(self, _arg: 'float const') -> "void":
        """SetSaltValue(itkSaltAndPepperNoiseImageFilterIF2IF2 self, float const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_SetSaltValue(self, _arg)


    def GetSaltValue(self) -> "float":
        """GetSaltValue(itkSaltAndPepperNoiseImageFilterIF2IF2 self) -> float"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_GetSaltValue(self)


    def SetPepperValue(self, _arg: 'float const') -> "void":
        """SetPepperValue(itkSaltAndPepperNoiseImageFilterIF2IF2 self, float const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_SetPepperValue(self, _arg)


    def GetPepperValue(self) -> "float":
        """GetPepperValue(itkSaltAndPepperNoiseImageFilterIF2IF2 self) -> float"""
...
itkSaltAndPepperNoiseImageFilterIF2IF2.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIF2IF2)
itkSaltAndPepperNoiseImageFilterIF2IF2.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIF2IF2)
itkSaltAndPepperNoiseImageFilterIF2IF2.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIF2IF2)
itkSaltAndPepperNoiseImageFilterIF2IF2.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF2IF2_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIF2IF2)
...
itkSaltAndPepperNoiseImageFilterIF3IF3.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF3IF3_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIF3IF3)
itkSaltAndPepperNoiseImageFilterIF3IF3.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF3IF3_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIF3IF3)
itkSaltAndPepperNoiseImageFilterIF3IF3.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF3IF3_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIF3IF3)
itkSaltAndPepperNoiseImageFilterIF3IF3.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIF3IF3_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIF3IF3)
...
class itkSaltAndPepperNoiseImageFilterISS2ISS2(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterISS2ISS2):
    ...
    def SetSaltValue(self, _arg: 'short const') -> "void":
        """SetSaltValue(itkSaltAndPepperNoiseImageFilterISS2ISS2 self, short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_SetSaltValue(self, _arg)


    def GetSaltValue(self) -> "short":
        """GetSaltValue(itkSaltAndPepperNoiseImageFilterISS2ISS2 self) -> short"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_GetSaltValue(self)


    def SetPepperValue(self, _arg: 'short const') -> "void":
        """SetPepperValue(itkSaltAndPepperNoiseImageFilterISS2ISS2 self, short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_SetPepperValue(self, _arg)


    def GetPepperValue(self) -> "short":
        """GetPepperValue(itkSaltAndPepperNoiseImageFilterISS2ISS2 self) -> short"""
...
itkSaltAndPepperNoiseImageFilterISS2ISS2.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterISS2ISS2)
itkSaltAndPepperNoiseImageFilterISS2ISS2.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterISS2ISS2)
itkSaltAndPepperNoiseImageFilterISS2ISS2.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterISS2ISS2)
itkSaltAndPepperNoiseImageFilterISS2ISS2.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS2ISS2_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterISS2ISS2)
...
itkSaltAndPepperNoiseImageFilterISS3ISS3.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS3ISS3_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterISS3ISS3)
itkSaltAndPepperNoiseImageFilterISS3ISS3.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS3ISS3_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterISS3ISS3)
itkSaltAndPepperNoiseImageFilterISS3ISS3.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS3ISS3_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterISS3ISS3)
itkSaltAndPepperNoiseImageFilterISS3ISS3.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterISS3ISS3_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterISS3ISS3)
...
class itkSaltAndPepperNoiseImageFilterIUC2IUC2(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterIUC2IUC2):
    ...
    def SetSaltValue(self, _arg: 'unsigned char const') -> "void":
        """SetSaltValue(itkSaltAndPepperNoiseImageFilterIUC2IUC2 self, unsigned char const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_SetSaltValue(self, _arg)


    def GetSaltValue(self) -> "unsigned char":
        """GetSaltValue(itkSaltAndPepperNoiseImageFilterIUC2IUC2 self) -> unsigned char"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_GetSaltValue(self)


    def SetPepperValue(self, _arg: 'unsigned char const') -> "void":
        """SetPepperValue(itkSaltAndPepperNoiseImageFilterIUC2IUC2 self, unsigned char const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_SetPepperValue(self, _arg)


    def GetPepperValue(self) -> "unsigned char":
        """GetPepperValue(itkSaltAndPepperNoiseImageFilterIUC2IUC2 self) -> unsigned char"""
...
itkSaltAndPepperNoiseImageFilterIUC2IUC2.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUC2IUC2)
itkSaltAndPepperNoiseImageFilterIUC2IUC2.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUC2IUC2)
itkSaltAndPepperNoiseImageFilterIUC2IUC2.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUC2IUC2)
itkSaltAndPepperNoiseImageFilterIUC2IUC2.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC2IUC2_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUC2IUC2)
...
itkSaltAndPepperNoiseImageFilterIUC3IUC3.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC3IUC3_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUC3IUC3)
itkSaltAndPepperNoiseImageFilterIUC3IUC3.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC3IUC3_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUC3IUC3)
itkSaltAndPepperNoiseImageFilterIUC3IUC3.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC3IUC3_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUC3IUC3)
itkSaltAndPepperNoiseImageFilterIUC3IUC3.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUC3IUC3_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUC3IUC3)
...
class itkSaltAndPepperNoiseImageFilterIUS2IUS2(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterIUS2IUS2):
    ...
    def __New_orig__() -> "itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer":
        """__New_orig__() -> itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2___New_orig__()

    __New_orig__ = staticmethod(__New_orig__)

    def Clone(self) -> "itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer":
        """Clone(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self) -> itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_Clone(self)


    def GetProbability(self) -> "double":
        """GetProbability(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self) -> double"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_GetProbability(self)


    def SetProbability(self, _arg: 'double const') -> "void":
        """SetProbability(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self, double const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_SetProbability(self, _arg)


    def SetSaltValue(self, _arg: 'unsigned short const') -> "void":
        """SetSaltValue(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self, unsigned short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_SetSaltValue(self, _arg)


    def GetSaltValue(self) -> "unsigned short":
        """GetSaltValue(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self) -> unsigned short"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_GetSaltValue(self)


    def SetPepperValue(self, _arg: 'unsigned short const') -> "void":
        """SetPepperValue(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self, unsigned short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_SetPepperValue(self, _arg)


    def GetPepperValue(self) -> "unsigned short":
        """GetPepperValue(itkSaltAndPepperNoiseImageFilterIUS2IUS2 self) -> unsigned short"""
    ...
    def cast(obj: 'itkLightObject') -> "itkSaltAndPepperNoiseImageFilterIUS2IUS2 *":
...
itkSaltAndPepperNoiseImageFilterIUS2IUS2.Clone = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_Clone, None, itkSaltAndPepperNoiseImageFilterIUS2IUS2)
...
itkSaltAndPepperNoiseImageFilterIUS2IUS2.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUS2IUS2)
itkSaltAndPepperNoiseImageFilterIUS2IUS2.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUS2IUS2)
itkSaltAndPepperNoiseImageFilterIUS2IUS2.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUS2IUS2)
itkSaltAndPepperNoiseImageFilterIUS2IUS2.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUS2IUS2)
...
def itkSaltAndPepperNoiseImageFilterIUS2IUS2___New_orig__() -> "itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer":
    """itkSaltAndPepperNoiseImageFilterIUS2IUS2___New_orig__() -> itkSaltAndPepperNoiseImageFilterIUS2IUS2_Pointer"""
    return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2___New_orig__()

def itkSaltAndPepperNoiseImageFilterIUS2IUS2_cast(obj: 'itkLightObject') -> "itkSaltAndPepperNoiseImageFilterIUS2IUS2 *":
    """itkSaltAndPepperNoiseImageFilterIUS2IUS2_cast(itkLightObject obj) -> itkSaltAndPepperNoiseImageFilterIUS2IUS2"""
    return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS2IUS2_cast(obj)

class itkSaltAndPepperNoiseImageFilterIUS3IUS3(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterIUS3IUS3):
    ...
    def __New_orig__() -> "itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer":
        """__New_orig__() -> itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3___New_orig__()

    __New_orig__ = staticmethod(__New_orig__)

    def Clone(self) -> "itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer":
        """Clone(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self) -> itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_Clone(self)


    def GetProbability(self) -> "double":
        """GetProbability(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self) -> double"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_GetProbability(self)


    def SetProbability(self, _arg: 'double const') -> "void":
        """SetProbability(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self, double const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_SetProbability(self, _arg)


    def SetSaltValue(self, _arg: 'unsigned short const') -> "void":
        """SetSaltValue(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self, unsigned short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_SetSaltValue(self, _arg)


    def GetSaltValue(self) -> "unsigned short":
        """GetSaltValue(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self) -> unsigned short"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_GetSaltValue(self)


    def SetPepperValue(self, _arg: 'unsigned short const') -> "void":
        """SetPepperValue(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self, unsigned short const _arg)"""
        return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_SetPepperValue(self, _arg)


    def GetPepperValue(self) -> "unsigned short":
        """GetPepperValue(itkSaltAndPepperNoiseImageFilterIUS3IUS3 self) -> unsigned short"""
    ...
    def cast(obj: 'itkLightObject') -> "itkSaltAndPepperNoiseImageFilterIUS3IUS3 *":
...
itkSaltAndPepperNoiseImageFilterIUS3IUS3.Clone = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_Clone, None, itkSaltAndPepperNoiseImageFilterIUS3IUS3)
...
itkSaltAndPepperNoiseImageFilterIUS3IUS3.SetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_SetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUS3IUS3)
itkSaltAndPepperNoiseImageFilterIUS3IUS3.GetSaltValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_GetSaltValue, None, itkSaltAndPepperNoiseImageFilterIUS3IUS3)
itkSaltAndPepperNoiseImageFilterIUS3IUS3.SetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_SetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUS3IUS3)
itkSaltAndPepperNoiseImageFilterIUS3IUS3.GetPepperValue = new_instancemethod(_itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3_GetPepperValue, None, itkSaltAndPepperNoiseImageFilterIUS3IUS3)
...
def itkSaltAndPepperNoiseImageFilterIUS3IUS3___New_orig__() -> "itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer":
    """itkSaltAndPepperNoiseImageFilterIUS3IUS3___New_orig__() -> itkSaltAndPepperNoiseImageFilterIUS3IUS3_Pointer"""
    return _itkSaltAndPepperNoiseImageFilterPython.itkSaltAndPepperNoiseImageFilterIUS3IUS3___New_orig__()

def itkSaltAndPepperNoiseImageFilterIUS3IUS3_cast(obj: 'itkLightObject') -> "itkSaltAndPepperNoiseImageFilterIUS3IUS3 *":
...
def salt_and_pepper_noise_image_filter_init_docstring():
    ...
    if isinstance(itk.SaltAndPepperNoiseImageFilter, itkTemplate.itkTemplate):
        salt_and_pepper_noise_image_filter.__doc__ = itk.SaltAndPepperNoiseImageFilter.values()[0].__doc__
    else:
        salt_and_pepper_noise_image_filter.__doc__ = itk.SaltAndPepperNoiseImageFilter.__doc__
