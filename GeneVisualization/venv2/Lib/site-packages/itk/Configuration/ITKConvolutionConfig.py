...
snake_case_functions = ('convolution_image_filter_base', 'convolution_image_filter', 'fft_convolution_image_filter', 'masked_fft_normalized_correlation_image_filter', 'fft_normalized_correlation_image_filter', )
