...
class itkVersorTransformD(itkRigid3DTransformPython.itkRigid3DTransformD):
    ...
    def GetVersor(self) -> "itkVersorD const &":
    ...
    def cast(obj: 'itkLightObject') -> "itkVersorTransformD *":
...
def itkVersorTransformD___New_orig__() -> "itkVersorTransformD_Pointer":
    """itkVersorTransformD___New_orig__() -> itkVersorTransformD_Pointer"""
    return _itkVersorTransformPython.itkVersorTransformD___New_orig__()

def itkVersorTransformD_cast(obj: 'itkLightObject') -> "itkVersorTransformD *":
