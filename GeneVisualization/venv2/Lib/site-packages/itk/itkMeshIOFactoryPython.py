...
class itkMeshIOFactory(ITKCommonBasePython.itkObject):
    """Proxy of C++ itkMeshIOFactory class."""
    ...
    ReadMode = _itkMeshIOFactoryPython.itkMeshIOFactory_ReadMode
    WriteMode = _itkMeshIOFactoryPython.itkMeshIOFactory_WriteMode

    def CreateMeshIO(path: 'char const *', mode: 'itkMeshIOFactory::FileModeType') -> "itkMeshIOBase_Pointer":
        """CreateMeshIO(char const * path, itkMeshIOFactory::FileModeType mode) -> itkMeshIOBase_Pointer"""
...
def itkMeshIOFactory_CreateMeshIO(path: 'char const *', mode: 'itkMeshIOFactory::FileModeType') -> "itkMeshIOBase_Pointer":
    """itkMeshIOFactory_CreateMeshIO(char const * path, itkMeshIOFactory::FileModeType mode) -> itkMeshIOBase_Pointer"""
    return _itkMeshIOFactoryPython.itkMeshIOFactory_CreateMeshIO(path, mode)
